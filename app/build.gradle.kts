...
dependencies {
    ...
    implementation(platform("androidx.compose:compose-bom:2023.08.00")) // 2023.08.00 !!
   ...
   // implementation(platform("org.jetbrains.kotlin:kotlin-stdlib-jdk7:1.8.0"))
    ...
    androidTestImplementation(platform("androidx.compose:compose-bom:2023.08.00")) //2023.08.00 !!
